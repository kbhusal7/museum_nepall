...
<div class="center-1">
  <div class="container-1" id="container2">
    <label for="show" class="close-btn" onclick="toggleR()" id="cut1"><i class="fa fa-times"
        aria-hidden="true">x</i></label>
    ...
    <form action="register.php" method='post' id="signup" name="signup">
      ...
      <div class="btn1">
        ...
        <button type="button" onclick="toggleR()">Cancel</button>
        <div class="login">Already a member?<a href="#" onclick="toggleR();" id="login"> Login
            now</a></div>
